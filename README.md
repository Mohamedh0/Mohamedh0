...
- 🧠 Deep diving into **Advanced Deep Learning architectures**
- 🤖 Building **NLP and Computer Vision applications**
...
```python
skills = {
    "AI/ML": ["Deep Learning", "NLP", "Computer Vision", "Model Optimization"],
    "Data Science": ["Data Visualization", "Feature Engineering", "Statistical Analysis"],
    "Development": ["Algorithm Design", "Problem Solving", "Code Optimization"],
...
I'm always open to collaborating on innovative projects and discussing AI/ML ideas.  
